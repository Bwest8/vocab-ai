...
import type { VocabSetSummary, WordWithRelations } from "@/lib/study/types";
...
export function StudyPageClient({ initialVocabSets, initialSet }: StudyPageClientProps) {
  const {
    vocabSets,
    selectedSetId,
    masterySegments,
    ...
    handleSelectExample,
  } = useStudySession({ initialVocabSets, initialSet });
